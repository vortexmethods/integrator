...
/*!
\file
\brief Файл c реализацией класса CompI3DK
...
CompI3DK::CompI3DK(const Database<3>& db_, const Parallel& par_, const Gausspoints<3>* const gp_) : Computer(db_, par_, gp_) {};
CompI3DK::~CompI3DK() {};

//I_3D(M_i, K_j) - интеграл от ньютоновского потенциала

double CompI3DK::evaluate(int i, int j)
{
...
#define AUTOSPLIT_I3DK

#ifdef AUTOSPLIT_I3DK		
