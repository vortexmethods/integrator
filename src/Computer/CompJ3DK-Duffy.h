...
/*!
\file
\brief Файл с описанием класса CompJ3DK_Duffy
...
public:
	...
	CompJ3DK_Duffy(const Database<3>& db_, const Parallel& par_, const Gausspoints<3>* const gp_, const GausspointsCube<2>* const gp2_, const GausspointsCube<3>* const gp3_);
	...
	*/
	...
	v3D IntDuffyContact(const i2D& ii, const i2D& jj, size_t& refineLevel);
	v3D IntDuffySosed(const i2D& ii, const i2D& jj, size_t& refineLevel);
